...
Instantiates residual network models.
...
class ResNet256_6_2_1(nn.Module):
    ...
    def __init__(self, block, blocks_per_layers, output_channels=1, 
...
def build_resnet256_6_2_1(block=BasicBlock, blocks_per_layers=[2, 2, 2, 2, 2, 2], 
                      pretrained=False, pretrained_model_path=None, output_channels=1, **kwargs):
